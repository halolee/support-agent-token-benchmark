...
- [ ] 2.1 Wire in Booking Systems tools (identical to Architecture A — extract to shared module if A is already done)
...
- [ ] 3.2 Implement agent loop — same shape as Architecture A
