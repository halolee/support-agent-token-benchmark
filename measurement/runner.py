...
def generate_report(
    *, results_dir: Path, output_path: Path
    ...
    minimal comparison markdown. Phase 2 / Step 11 will expand this to
    populate the full template in measurement/results/comparison.md.
    """
    ...
    lines = [
        ...
        "will populate the full template structure (per-class breakdown, ",
        "Silicon Data decomposition, adversarial review). This stub demonstrates",
